...
public class Checkout {
    ...
    public void testNameLengthAndFormat() {
        ...
        // Verify alert message
        String alertText = driver.switchTo().alert().getText();
        Assert.assertEquals(alertText, "Name should be at least 2 characters long and contain only alphabetic characters.");
    ...
    public void testCreditCardLength() {
        ...
        creditCardField.sendKeys("1234567890868686123456");
        ...
        Assert.assertEquals(successAlert.getText(), "credit card must be only 16 digit ");
    }
    @Test
