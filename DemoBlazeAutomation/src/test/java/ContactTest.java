...
public class ContactTest {
    ...
    public void testContactwithblankfields(){
        contact("" ,"" , "" );
        Assert.assertTrue(isAlertPresentWithText("Please fill out Contact Email,Contact Name and Message."));
    }

    @Test
    public void testContactwithinvalidemailformat(){
        contact("nadaaagmailcom" ,"nada" , "thankyou" );
        Assert.assertTrue(isAlertPresentWithText("Please Enter Valid Contact Email."));
    }
